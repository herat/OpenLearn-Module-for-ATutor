...
INSERT INTO `language_text` VALUES ('en', '_module','ol_admin_lpanel','The panel on the left side shows when the local ATutor database was last updated. To manually update the database to include the most recent changes on OpenLearn, click the \'Update Now\' button.',NOW(),'');
